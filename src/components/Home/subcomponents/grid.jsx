...
import ProjectGrid from "./projectStack";
    ...
    return (
        <div>
            <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 gap-5 lg:gap-10">
                ...
                <div className="md:col-span-2 md:row-span-2 lg:col-span-2 lg:row-span-2"><ConnectGrid /></div>
                <div className="md:col-span-5 md:row-span-3 lg:col-span-5 lg:row-span-3"><ProjectGrid /></div>
            </div>
        </div>
    );
}