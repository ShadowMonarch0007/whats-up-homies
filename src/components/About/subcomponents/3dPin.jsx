        ...
        <Link href={nlink}>
          <div className="flex flex-col basis-full justify-between p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-64 h-64 md:w-80 md:h-80">
            ...
            <div className="flex flex-col items-center justify-center gap-5 md:gap-0">
              <div className="w-full flex items-center justify-end translate-y-5 md:-translate-y-[30%]"><h1 className="max-w-xs !pb-2 !m-0 font-bold text-sm md:text-lg text-[#202020] dark:text-slate-100">{name}</h1></div>
