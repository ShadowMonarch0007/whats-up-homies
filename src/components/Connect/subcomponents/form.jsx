...
export function ConnectFormDemo() {
    ...
    return (
        <>
            ...
            <div className="max-w-4xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-[#e0e0e0]/50 dark:bg-[#202020]/50 border-4 border-[#e0e0e0] dark:border-[#202020]">
