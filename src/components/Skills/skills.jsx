...
const cards = [
    {
        ...
        thumbnail: <div className="h-20 lg:h-60 flex justify-evenly items-center  backdrop-blur-[1.5px] rounded-xl lg:rounded-3xl border-1 lg:border-2 border-[#e0e0e0] dark:border-[#202020]"><div><Image className="h-full w-16 lg:w-56" src={Cpp} /></div></div>
    },
    {
        id: 2,
        content: <WebDevCertificate />,
        className: "col-span-1",
        thumbnail: <div className="h-20 lg:h-60 flex justify-evenly items-center  backdrop-blur-[1.5px] rounded-xl lg:rounded-3xl border-1 lg:border-2 border-[#e0e0e0] dark:border-[#202020]"><div><Image className="h-full w-16 lg:w-56" src={Java} /></div></div>
    },
    {
        id: 3,
        content: <WebDevCertificate />,
        className: "col-span-2 row-span-2 ",
        thumbnail: <div className="h-[180px] lg:h-[520px] flex justify-evenly items-center backdrop-blur-[1.5px] rounded-xl lg:rounded-3xl border-1 lg:border-2 border-[#e0e0e0] dark:border-[#202020]"><div><Image className="h-full w-44 lg:w-[500px] hidden dark:block" src={Fwd} /><Image className="h-full w-44 lg:w-[500px] dark:hidden" src={FwdL} /></div></div>
    },
    {
        id: 4,
        content: <WebDevCertificate />,
