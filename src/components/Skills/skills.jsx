...
const cards = [
    ...
    },
    {
        ...
        content: <WebDevCertificate />,
        className: "row-span-2 col-span-1",
        thumbnail: <div className="flex flex-col gap-y-4 justify-center items-center backdrop-blur-[1.5px] rounded-xl lg:rounded-3xl border-2 border-[#e0e0e0] dark:border-[#202020] "><Image className="h-full w-full pt-1.5 lg:pt-7" src={Aui} /><Image className="h-full w-full" src={Chart} /></div>
    },
    // {
    //     id: 11,
    //     content: <WebDevCertificate />,
